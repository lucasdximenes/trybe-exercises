...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    expect(test1).toHaveProperty('fetchMenu');
    ...
    expect(test2.fetchMenu()).toEqual({ food: {}, drink: {} });
    ...
    // ```
    const test3 = createMenu({ food: {}, drink: {}, other: {} });
    expect(test3.fetchMenu()).toEqual({ food: {}, drink: {}, other: {} });
    ...
    // ```
    const test4 = createMenu({ food: {}, drink: {}, other: {} });
    expect(test4.consumption).toEqual([]);
    ...
    expect(teste5.consumption).toEqual(['coxinha']);
    ...
    expect(teste6.consumption).toEqual(['coxinha', 'agua', 'sopa', 'sashimi']);
    ...
    teste7.order('agua');
    teste7.order('coxinha');
    expect(teste7.consumption).toEqual(['coxinha', 'agua', 'coxinha']);
