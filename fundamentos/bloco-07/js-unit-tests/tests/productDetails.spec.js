...
/*
  A função productDetails recebe duas strings que representam nomes de produtos,
  e retorna um array contendo dois objetos com os detalhes dos respectivos
  produtos.
  ...
  Comportamento: productDetails('Alcool gel', 'Máscara')
  ...
  Escreva pelo menos cinco testes para essa função para garantir que a
...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    expect(productDetails('Máscara', 'Alcool gel')[0]).not.toBe(productDetails('Alcool gel', 'Máscara')[0]);
