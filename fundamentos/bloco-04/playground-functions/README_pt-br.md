...
- Para que seja possível formar um triângulo, é necessário que **a medida de _qualquer_ um dos lados** atenda às seguintes condições:
...
- Para simplificar, considere que a string **sempre** terá o formato _quantidade (em número) + tipo da bebida_;
